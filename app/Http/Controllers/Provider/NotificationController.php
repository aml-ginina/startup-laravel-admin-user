...
class NotificationController extends AppBaseController
{
    ...
    {
        $notifications = Auth::guard('provider')->user()->getNotifications()->get();
    ...
    {
        return view('provider.notifications.create');
    }
    ...
    {
        $input = $request->except('users', 'providers');
    ...
    public function show($id)
    {
        ...
        if ($notification->to != 'provider' || (!is_null($notification->provider_id) && $notification->provider_id != Auth::guard('provider')->user()->id)) {
        ...
        return view('provider.notifications.show')->with('notification', $notification);
    }
