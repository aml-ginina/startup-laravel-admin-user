                ...
                <div class="message-center">
                    ...
                    <a href="javascript:void(0)">
                        ...
                        <div class="mail-contnet">
                            <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my provider!</span> <span class="time">9:30 AM</span> </div>
                    </a>
                    <!-- Message -->
                    <a href="javascript:void(0)">
                    ...
                    <a href="javascript:void(0)">
                        ...
                        <div class="mail-contnet">
                            <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my provider!</span> <span class="time">9:02 AM</span> </div>
                    </a>
                </div>
            </li>
            <li>
