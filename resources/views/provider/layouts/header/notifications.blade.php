...
<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
        <i class="ti-bell"></i>
        @if(($notifs = Auth::guard('provider')->user()->getNotifications(0))->count() > 0)
        ...
        <ul>
            ...
            <li>
                <div class="message-center">
                    ...
                    <!-- Message -->
                    <a href="{{ route('provider.notifications.show', $notif->id) }}">
            ...
            <li>
                <a class="nav-link text-center link" href="{{ route('provider.notifications.index') }}"> <strong>Check all notifications</strong> <i class="fa fa-angle-right"></i> </a>
            </li>
        </ul>
    </div>
</li>
